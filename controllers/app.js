  ...
  return res.status(400).json({ error: "Email del usuario inválido o no definido" });
    ...
    const contenidoHTML = `
      <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f9f9f9;">
        ...
        <p>Gracias por confiar en <strong>FISA</strong>. Nuestro equipo te contactará si es necesario o podés responder a este correo para consultas.</p>
        <hr/>
        <p style="color: #888;">FISA - Financial Intelligence for Smart Approval</p>
      </div>
    `;
